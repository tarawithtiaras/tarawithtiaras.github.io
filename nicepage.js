! function (t) {
    ...
    }, e.p = "/Content/BundledScripts/", e(e.s = 11910)
}({
    110: function (t, e, n) {
        "use strict";
                            ...
                            if (e)
                                if (!fe && !le && !Rt) {
                                    var i = e,
                                        o;
                                    if (kn)
                                        if (clearTimeout(kn), kn = null, Be(i, Dn)) return ct("doubleTap", i), void 0;
    ...
    11931: function (t, e, n) {
        "use strict";
        var i = n(15);
        n(11932), i(window).on("load", (function () {
            var t;
    ...
    11933: function (t, e, n) {
        ...
        n(11934), i.prototype.initialize = function t(e) {
            if (!this.waypoint)
    ...
    11939: function (t, e, n) {
        ...
        var Animation = n(11940),
            i = n(266);
        n(585), n(11944), window.uAnimation = new Animation(i.instance()).init()
    },
    ...
    11945: function (t, e, n) {
        ...
        function i(t) {
            this.mode = t || "XL", this.animations = this.initTimeline(), this._responsiveListener = this.responsiveListener.bind(this), this._prevState = {}
        }
        t.exports = i;
        var o = n(11946);
        i.prototype.subscribe = function () {
            ...
            if (this._prevState.scrollY !== t.scrollY) this.animations.forEach((function (e) {
                e.animation.calc(t), e.animation.apply()
            })), this._prevState = t
    ...
    11946: function (t, e, n) {
        ...
        function i(t, animation, e) {
            this.dom = t, this.mode = e, this.animation = animation, this.initSteps(), this.state = null
        }
        t.exports = i;
        var o = "before",
            a = "start",
        ...
        Object.defineProperty(i.prototype, "steps", {
            ...
            if (this.state = {
                ...
                this.steps.forEach((function (t) {
                    var e = o;
                    if (n >= t.start && n < t.end) e = a;
                    else if (n >= t.end) e = s;
                    else if (n < t.start) e = o;
                    var i = this.getStepProgress(e, t, n);
                    this.calcStep(e, t, i)
                }), this)
            }
        }, i.prototype.getGlobalProgress = function (t) {
            var animation, e, n = ((this.animation.XL || {}).start || {}).at || "bottom",
                i = this.domTop,
                o;
            if ("top" === n && this.domTop < 0) i += -this.domTop;
            if ("middle" === n) {
                if (this.domTop < t.vh / 2) i += t.vh / 2 - this.domTop;
                i -= t.vh / 2
            }
            if ("bottom" === n) {
                if (this.domTop < t.vh) i += t.vh - this.domTop;
                i -= t.vh
            }
            ...
            this.state.willChange = t !== s, this.calcStepPropertyToggle(t, e, "sticky", true), this.calcStepPropertyToggle(t, e, "fixed"), this.state.mx += (e.mx - this.state.mx) * n, this.state.my += (e.my - this.state.my) * n, this.state.op += (e.op - this.state.op) * n, this.state.sx += (e.sx - this.state.sx) * n, this.state.sy += (e.sy - this.state.sy) * n, this.state.rot += (e.rot - this.state.rot) * n, this.state.bgy += (e.bgy - this.state.bgy) * n, this.state.blur += (e.blur - this.state.blur) * n
        }, i.prototype.calcStepPropertyToggle = function (t, e, n, i) {
            if (e[n])
                if (!(t === o && this.state[n] && e.index > 0))
                    if (t === a) this.state[n] = true;
                    else if (t === s) this.state[n] = i ? e[n] : false
        }, i.prototype.apply = function () {
            if (this.state) {
                var t = "transform, opacity, filter",
                    e = getComputedStyle(this.dom);
                if ("auto" === e.willChange && this.state.willChange) this.dom.style["will-change"] = "transform, opacity, filter";
                else if (e.willChange === t && !this.state.willChange) this.dom.style["will-change"] = "";
                var transform = [];
                if (this.state.mx) transform.push("translateX(" + this.state.mx.toFixed(3) + "px)");
                if (this.state.my) transform.push("translateY(" + this.state.my.toFixed(3) + "px)");
                if (this.state.rot) transform.push("rotate(" + this.state.rot.toFixed(3) + "deg)");
                if (1 !== this.state.sx || 1 !== this.state.sy) transform.push("scale(" + this.state.sx.toFixed(3) + ", " + this.state.sy.toFixed(3) + ")");
                if (!transform.length) transform.push("rotate(0deg)");
                this.dom.style.transform = transform.join(" "), this.dom.style.opacity = 1 === this.state.op ? "" : this.state.op.toFixed(3), this.dom.style.filter = this.state.blur ? "blur(" + this.state.blur.toFixed(3) + "px)" : "", this.dom.classList.toggle("u-animation-sticky", Boolean(this.state.sticky))
            }
        }
    },
    ...
    585: function (t, e, n) {
        ...
        i.registerAnimation(n(586)), i.registerAnimation(n(589)), i.registerAnimation(n(267))
    },
    586: function (t, e, n) {
        "use strict";
